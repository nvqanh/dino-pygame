# NVQAnh's Pygame Dino
This pygame Dino project is a clone of the classic Google Chrome game. It is my first actual game written using pygame.

Credits:

- Me ([@nvqanh](https://github.com/nvqanh)) for much of the coding. I also re-drew many of the assets based on the original Chrome Dino (except the background).
